...
define(['jquery', 'underscore', 'backbone', 'models/record', 'models/recordcontainer', 'collections/recordcontainers', 'views/record', 'common'], function($, _, Backbone, Record, RecordContainer, RecordContainers, RecordView, Common) {
  'use strict';
