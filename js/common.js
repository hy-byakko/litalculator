...
define(['underscore', 'backbone', 'moment', 'Dropbox', 'eventmgr', 'jQuery.indexedDB'], function(_, Backbone, moment, Dropbox, eventManager) {
  'use strict';
  var client, defaultMetaData, metaData, metaStore, selectExpend, targetDate;
